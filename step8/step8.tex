...
One of Dart¡Çs core features is that it compiles to modern JavaScript to run across the modern web.
...
\begin{itemize}
\item {\bf Note:} As of 2012-06-26, FireFox wouldn¡Çt connect. We don¡Çt think this is a Dart issue, but a WebSocket issue. Suggestions most welcome! If you have Firefox, please test WebSockets at \url{http://www.websocket.org/echo.html} and let us know.
\item {\bf Note:} As of 2012-06-26, Safari does not speak the latest version of the WebSockets protocol. Here¡Çs the bug to track: \url{http://code.google.com/p/dart/issues/detail?id=3631}
\end{itemize}
